...
lint-py:  ## lint python with ruff
	python -m ruff check ipyprint
	python -m ruff format --check ipyprint
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ipyprint
	python -m ruff format ipyprint
...
test:  ## run python tests
	python -m pytest -v ipyprint/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ipyprint/tests --cov=ipyprint --cov-report term-missing --cov-report xml
